...
public abstract class PhoneInfor6 implements Infor { // extends Object 
	...
	// 생성자: 3개의 데이터를 받아 초기화
	PhoneInfor6(String name, String phoneNumber, String address, String email){
	...
	// 추상메소드 void showBasicInfor()를 멤버로 가진다. 
