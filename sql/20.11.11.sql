...
select employee.ename, employee.empno, manager.ename
from emp employee, emp manager
where employee.mgr = manager.empno -- employee.매니저사번=manager.사원의사번
;
...
from emp employee, emp manager
where employee.hiredate<manager.hiredate and manager.job='MANAGER'
;