...
window.onload = function () {
    ...
    // localStorage.getItem('members')에 저장값이 없으면 null을 반환
    if(localStorage.getItem('members')==null){
        // 초기 배열을 저장: 배열을 문자열로 변경해서 저장
...
function regmember() {
    ...
    var check = false; // 문제가 없는 경우

    // 공백 문자를 검사: trim()을 이용해서 공백 제거 -> 문자열 비교 => 다신
...
function editMemberdata(){
    ...
    // members[index] -> pw, name 수정 가능하게 설정
